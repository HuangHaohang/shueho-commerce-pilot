...
- Routes every governed JustOneAPI request through one client with a protected token pool, random selection among eligible per-interface keys, atomic quota reservation/debit, scoped exhaustion and immutable attempt receipts. See [token quota operation](./docs/deployment/justoneapi-tokens.md).
