    ...
    >
      ...
      <LegalSection title="二、AI 能做什么">
        <ul>
          ...
          <li>通过受控 MCP 工具查询公开网页及经企业允许的第三方市场数据；</li>
      ...
      <LegalSection title="六、工具调用与外部操作">
        ...
        <p>
          Commerce Pilot 不是电脑控制工具。外部数据权限只适用于应用登记的接口，不授予模型访问您的电脑、本机文件、任意网站或未登记网络服务。JustOneAPI 的收费调用会经过企业策略、用户确认、额度预占和审计；上游结果不确定时不会自动重试。
        </p>
      </LegalSection>

      <LegalSection title="七、市场调研与数据局限">
        <p>
          市场调研可能综合公开网页、JustOneAPI 返回数据和 AI 推断。第三方数据可能延迟、缺失或因平台规则变化而失效，AI 也可能错误归纳；报告中的平台、时间范围、来源、口径和推断应分别核验。调研结果不构成销量、收益、排名、投放效果或平台合规保证。
        </p>
      </LegalSection>

      <LegalSection title="八、生成内容标识">
        <p>
          界面会持续提示您正在使用 AI。对依法需要标识的生成文本、图片、音频、视频或虚拟场景，正式提供生成、下载、复制或导出功能时，将按适用规则添加显式或隐式标识。您不得恶意删除、篡改、伪造或隐匿依法添加的标识。
        </p>
      </LegalSection>

      <LegalSection title="九、反馈、申诉与人工支持">
        <p>
          如您发现错误输出、违法有害内容、个人信息问题或未经授权的操作，应停止继续执行并保存相关任务记录。反馈、申诉和投诉可通过法律页面顶部列示的客服或个人信息保护联系方式提交；未配置有效渠道的部署不得对外提供服务。
        </p>
      </LegalSection>
