...
export const EXTERNAL_DATA_SERVICE_REQUIRED_TOOLS = [
  "submit_research_task","read_research_task","claim_research_task","update_research_task","recover_research_call",
...
export class ExternalDataServiceMcpClient {
  ...
  taskOperation(name: "submit_research_task"|"read_research_task"|"claim_research_task"|"update_research_task"|"recover_research_call",args:Record<string,unknown>):Promise<ExternalDataServiceToolResult>{return this.callCatalog(name,args);}
