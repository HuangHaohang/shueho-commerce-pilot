...
export function taskToolContract(spec:any):any{
 ...
 tools.push(...[
 {name:'list_research_tasks',properties:{cursor:{type:'string',maxLength:512},limit:{type:'integer',minimum:1,maximum:50}},required:[]},
 {name:'cancel_research_task',properties:{task_id:{type:'string',format:'uuid'}},required:['task_id']},
 {name:'get_research_records',properties:{cursor:{type:'string',maxLength:512},snapshot_id:{type:'string',format:'uuid'},task_id:{type:'string',format:'uuid'},research_request_id:{type:'string',format:'uuid'},offset:{type:'integer',minimum:0,maximum:2147483647},limit:{type:'integer',minimum:1,maximum:100}},required:[]},
