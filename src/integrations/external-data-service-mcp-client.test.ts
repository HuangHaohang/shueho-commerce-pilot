...
function createMockServer(): McpServer {
  ...
  for (const name of ["read_research_records","manage_research_task","research_queue_health","submit_research_task","read_research_task","claim_research_task","update_research_task","recover_research_call","search_data_capabilities","get_data_capability","plan_data_request","claim_data_request_plan","execute_data_request_plan","cancel_data_request_plan"]) {
