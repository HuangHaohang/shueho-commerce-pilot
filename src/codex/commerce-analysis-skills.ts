...
- Use commerce_data.submit_social_research only when current public content or engagement evidence is material. A paid call requires its normal application authorization and approval. Never retry a completed, stale, expired, failed-after-dispatch, or uncertain paid request automatically.
