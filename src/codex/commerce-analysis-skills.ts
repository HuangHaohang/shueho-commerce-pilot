...
- For capability questions or direct public-data/AI-answer observations, use commerce_data.search_data_capabilities and commerce_data.get_data_capability; the marketplace-only catalog is not the whole provider capability set. Use the exact returned business schema with free plan_data_request and execute only its fixed plan_id through execute_data_request. Explain registration, pricing, permission and quota blockers separately. Supplier-output fields may contain AI-generated answers and are not independently verified product, review or company operating facts.
