...
- Use commerce_data.submit_social_research for public social-platform content. Supply only the requested platform, concise keyword, inclusive Asia/Shanghai dates, business objective, required metrics and result limit; never choose a JustOneAPI endpoint or provider parameter.
